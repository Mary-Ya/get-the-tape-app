...
module.exports = {
    ...
    login: (req, res) => {
        ...
        var scope = 'user-read-private user-read-email streaming playlist-read-private playlist-read-collaborative playlist-modify-public playlist-modify-private';
